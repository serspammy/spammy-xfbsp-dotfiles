...
### note: i've switched to kde with krohnkite now so this repo is super unmaintained. also the "setup guide" is horribly written and idk if i'll ever get around to cleaning it up
